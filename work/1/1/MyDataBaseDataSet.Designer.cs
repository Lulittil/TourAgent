...
namespace _1.MyDataBaseDataSetTableAdapters {
...
SELECT Id, HName, Rooms, Country FROM Hotels WHERE (Id = @Id)";
        ...
        public virtual int Fill(MyDataBaseDataSet.HotelsDataTable dataTable) {
        ...
        public virtual MyDataBaseDataSet.HotelsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            MyDataBaseDataSet.HotelsDataTable dataTable = new MyDataBaseDataSet.HotelsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(MyDataBaseDataSet.HotelsDataTable dataTable) {
